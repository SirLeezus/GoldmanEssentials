        ...
        if (sender instanceof Player) {
            ...
            if (plugin.getPU().getSellableItems().contains(itemHand)) {
                ...
                if (ItemSellValues.valueOf(name).getItem().equals(itemHand)) {
                    ...
                    player.sendMessage(Lang.NORMAL_WARNING.getString(null) + Lang.COMMAND_WORTH_SUCCESSFUL.getString(new String[] { plugin.getPU().formatMaterial(name), plugin.getPU().formatAmount(value) }));
