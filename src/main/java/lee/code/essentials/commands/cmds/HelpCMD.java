...
public class HelpCMD implements CommandExecutor {
    ...
    private final List<String> commands = Arrays.asList("zap", "world", "weather", "vanish", "time", "teleportdeny", "teleportaccept", "teleport", "summon", "staffchat", "spawn", "sound", "setspawn", "setrank", "setprefix", "setcolor", "setrank", "reply", "rankup", "ranklist", "money", "message", "itemname", "invsee", "help", "heal", "head", "god", "glow", "give", "gamemode", "flyspeed", "fly", "feed", "enchant", "balancetop", "balance", "advancement");
