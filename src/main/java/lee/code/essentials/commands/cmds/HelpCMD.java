...
public class HelpCMD implements CommandExecutor {
    ...
    private final List<String> commands = Arrays.asList("essreload", "ban", "tempban", "unban", "banlist", "mute", "unmute", "kick", "zap", "colors", "playtime", "world", "weather", "vanish", "time", "teleportdeny", "teleportaccept", "teleport", "summon", "staffchat", "spawn", "sound", "home", "sethome", "deletehome", "setspawn", "setrank", "setprefix", "setcolor", "setrank", "reply", "rankup", "ranklist", "sell", "sellall", "worth", "money", "message", "itemname", "invsee", "enderchest", "help", "heal", "head", "god", "glow", "give", "gamemode", "flyspeed", "fly", "feed", "enchant", "balancetop", "balance", "advancement");
