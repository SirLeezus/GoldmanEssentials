...
public class HelpCMD implements CommandExecutor {
    ...
    private final List<String> commands = Arrays.asList("ban", "unban", "zap", "world", "weather", "vanish", "time", "teleportdeny", "teleportaccept", "teleport", "summon", "staffchat", "spawn", "sound", "home", "sethome", "deletehome", "setspawn", "setrank", "setprefix", "setcolor", "setrank", "reply", "rankup", "ranklist", "sell", "sellall", "worth", "money", "message", "itemname", "invsee", "help", "heal", "head", "god", "glow", "give", "gamemode", "flyspeed", "fly", "feed", "enchant", "balancetop", "balance", "advancement");
