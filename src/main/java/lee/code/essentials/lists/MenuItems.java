...
public enum MenuItems {
    ...
    WELCOME_11(Material.ENCHANTED_BOOK, "&d&lCustom Enchants", "&aThere are a few custom enchants on this server which\n&acan be obtained by enchanting an item at level 30 on \n&aan enchanting table. To view a list of all the custom\n&aenchants run the command &e/help enchants&a. This\n&aserver also allows you to transfer enchants from\n&aarmor and items to enchanted books through anvils."),
