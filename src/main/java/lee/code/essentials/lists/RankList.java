...
public enum RankList {
    ...
    IMMORTAL("&e[&#0074F6Immortal&e]", "DARK_GREEN", 60, "ASCENDANT", 7000, 7000),
    ASCENDANT("&e[&#F500F5Ascendant&e]", "DARK_PURPLE", 75, "GOD", 8000, 8000),
    GOD("&#FF7800[&e&lGod&#FF7800]","GOLD", 86, "LAST", 10000, 10000),

    //STAFF
    MOD("&d[&5&lMod&d]", "LIGHT_PURPLE", 86, "STAFF", 100000, 10000),
    ADMIN("&2[&a&lAdmin&2]", "DARK_GREEN", 86, "STAFF", 100000, 10000),
    OWNER("&6[&#F40000&lOwner&6]", "GOLD", 86, "STAFF", 100000, 10000),
    ;
