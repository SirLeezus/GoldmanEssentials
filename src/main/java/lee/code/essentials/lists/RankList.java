...
public enum RankList {
    ...
    ASCENDANT(false, "&e[&#F500F5Ascendant&e]", "DARK_PURPLE", 90, "GOD", 8000, 8000, "2"),
    GOD(false, "&#FF7800[&e&lGod&#FF7800]","GOLD", 97, "LAST", 10000, 10000, "1"),

    //STAFF
    MOD(true, "&d[&5&lMod&d]", "LIGHT_PURPLE", 97, "STAFF", 100000, 10000, "c"),
    ADMIN(true, "&2[&a&lAdmin&2]", "DARK_GREEN", 97, "STAFF", 100000, 10000, "b"),
    OWNER(true, "&6[&#F40000&lOwner&6]", "GOLD", 97, "STAFF", 100000, 10000, "a"),
    ;
