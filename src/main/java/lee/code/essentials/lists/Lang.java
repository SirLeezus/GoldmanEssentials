...
public enum Lang {
    ...
    TABLIST_HEADER("&#228B22▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n&r\uE790 &#4dc462&lJourney Advancement &r\uE790\n&#228B22▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬"),
    ...
    COMMAND_PLAYTIME_TARGET_SUCCESSFUL("&aThe player &6{0} &ahas played&7: &e{1}"),
    ...
    COMMAND_LOCKHOTBAR_TOGGLE_SUCCESSFUL("&aYour hotbar lock was successfully toggled {0}&a!"),
    ...
    COMMAND_BALANCE_SUCCESSFUL("&aBalance&7: &6${0}"),
    COMMAND_BALANCE_TARGET_SUCCESSFUL("&aThe player &6{0} &ahas a balance of&7: &6${1}"),
    ...
    COMMAND_WORTH_SUCCESSFUL("&a&lItem&7: &b{0}\n&a&lServer Worth&7: &6${1}\n&a&lHand Worth&7: &6${2}\n&a&lInventory Worth&7: &6${3}"),
    ...
    COMMAND_WORTH_TITLE("&a----------- &e[ &2&lWorth Info &e] &a-----------"),
    ...
    COMMAND_CHECKPERMS_TITLE("&a--------- &e[ &2&lPlayer Perms &e] &a---------"),
    ...
    COMMAND_HELP_ENCHANTS_TITLE("&a----------- &e[ &2&lLegendary Enchantments &e] &a-----------"),
    COMMAND_HELP_ENCHANTS_DIVIDER("&a--------------------------------------------------"),
    COMMAND_HELP_MYSTERY_BOX_TITLE("&a---------------- &e[ &2&lMystery Boxes &e] &a----------------"),
    COMMAND_HELP_MYSTERY_BOX_DIVIDER("&a---------------------------------------------------"),
    COMMAND_HELP_SKINS_TITLE("&a--------------------- &e[ &2&lSkins &e] &a---------------------"),
    COMMAND_HELP_SKINS_DIVIDER("&a---------------------------------------------------"),
    ...
    COMMAND_CHECKPERMS_LINE("&3{0}&b. &6{1}"),
    ...
    ERROR_LOCKED_HOTBAR("&cYou can't drop items while you have hotbar lock toggled on!"),
    ERROR_TAMED_SIT("&cThis pet is owned by &6{0} &cand only they can make it sit or stand up."),
    ERROR_ITEMNAME_NO_ITEM("&cYou must be holding the item you want to rename to run this command."),
