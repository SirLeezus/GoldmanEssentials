...
public enum Lang {
    ...
    COMMAND_UNBANIP_SUCCESSFUL("&aThe IP &e{0} &awas successfully unbanned!"),
    ...
    ERROR_COMMAND_SETSUFFIX_ARG("&cYou need to input a target player and new suffix to run this command."),
