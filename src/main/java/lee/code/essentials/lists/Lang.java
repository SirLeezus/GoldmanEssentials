...
public enum Lang {
    ...
    ERROR_RENAME_BLOCKED("&cYou cannot rename the item you're holding."),
    ERROR_RENAME_NO_ITEM("&cYou must be holding the item you want to rename to run this command."),
    ERROR_RENAME_LENGTH("&cYou can only rename items with a max of 25 characters."),
