...
public enum Lang {
    ...
    VOTE("&2The player &6{0} &2just voted for the server and received &6$10,000&2!"),
    ...
    COMMAND_DEFAULT_HOMES("&6&lDefault Homes&7: &2{0}"),
    COMMAND_HOME_TOTAL_HOMES("&6&lTotal Homes&7: &2{0}&7/&2{1}"),
    COMMAND_HOME_TIME_PLAYED("&6&lTime Played&7: &2{0}"),
    COMMAND_HOME_ACCRUED_TIMER("&6&lAccrued Timer&7: &21 home every {0} &2played"),
    COMMAND_HOME_ACCRUED_HOMES("&6&lAccrued Homes&7: &2&2{0}&7/&2{1}"),
    ...
    COMMAND_VOTE_REWARDS("&e&lReward: &6$10,000"),
    ...
    ERROR_COMMAND_TRADE_NOT_ARG("&cThe input {0} is not a valid arg for this command."),
