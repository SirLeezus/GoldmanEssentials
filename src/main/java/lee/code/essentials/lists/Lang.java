...
public enum Lang {
    ...
    COMMAND_LOGGER_TOGGLE("&aLogger mode has been toggled {0}&a!"),
    COMMAND_LOGGER_TITLE("&a------------------ &e[ &2&lLogger &e] &a------------------"),
    COMMAND_LOGGER_LOCATION("&3&lLocation: &b{0}"),
    COMMAND_LOGGER_SPLITTER("&a---------------------------------------"),
